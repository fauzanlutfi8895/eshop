      ...
      <div className="md:w-[80%] w-[90%] m-auto md:flex h-full items-center">
        <div className="md:w-1/2">
          ...
          <p className="font-Oregano text-3xl pt-4 text-white">
            Exlusive offer <span className="text-yellow-400">10%</span> this
            week
          </p>
          <br />
          <button
            onClick={() => router.push("/products")}
            className="w-[140px] gap-2 font-semibold h-[40px] hover:text-white text-black bg-white rounded-md flex items-center justify-center"
          >
            Shop now <MoveRight />
          </button>
        </div>
