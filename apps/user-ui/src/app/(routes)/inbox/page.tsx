...
const Page = () => {
  ...
  // Menampilkan isi chat saat select chat nya dan arahkan ke query conversationId
            ...
            {selectedChat ? (
              <>
                ...
                <div className="p-4 border-b border-b-gray-200 bg-white flex items-center gap-3">
                  <Image
                    src={
                      selectedChat.seller?.avatar || AVATAR_IMAGE_PLACEHOLDER
                    }
                ...
                {/* Content Chat (flex-1 menyebabkan paling bawah)*/}
                <div
